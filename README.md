...
最大迭代次数设置为240，学习率从0.4线性衰减到0，batch_size设为512，其余参数保持不变，训练结果如下：
...
epoch232：Acc@1 66.780 Acc@5 87.418
epoch233：Acc@1 67.586 Acc@5 87.832
epoch234：Acc@1 67.514 Acc@5 87.900
epoch235：Acc@1 67.932 Acc@5 88.038
epoch236：Acc@1 68.536 Acc@5 88.110
epoch237：Acc@1 68.684 Acc@5 88.318
epoch238：Acc@1 68.908 Acc@5 88.514
epoch239：Acc@1 69.082 Acc@5 88.578

最后精度仍然没有达到文章的结果，但比较接近。从训练的过程中可以发现，学习率线性衰减精度上升的很慢，但精度最终比指数衰减高，指数衰减衰减到一定程度学习率变得很小，得不到充分的训练，所以精度往往不会很高。
...
视频分类的各个步骤（包括测试一个视频的识别结果）可以参考 https://github.com/fourierer/Video_Classification_ResNet3D_Pytorch
